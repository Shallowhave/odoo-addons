...
class StockMove(models.Model):
	...
	secondary_quantity = fields.Float('第二单位数量', compute='_quantity_secondary_compute', digits='Product Unit of Measure', store=True)
	secondary_done_qty = fields.Float('第二单位已完成', compute='_quantity_secondary_done_compute', digits='Product Unit of Measure', inverse='_quantity_secondary_done_set')
...
class StockMoveLine(models.Model):
	...
	secondary_uom_id = fields.Many2one('uom.uom', string="第二单位",compute="_compute_secondary_qty" ,store=True)
	secondary_quantity = fields.Float("第二单位数量", digits='Product Unit of Measure' ,compute="_compute_secondary_qty" ,store=True)
	secondary_done_qty = fields.Float("第二单位已完成", digits='Product Unit of Measure')
