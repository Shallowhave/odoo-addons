...
def run_tests():
    ...
    files_to_check = {
        ...
        "reports/quality_report_data.xml": False,
        "reports/quality_report.xml": False,
    }
    ...
    xml_files = [
        ...
        os.path.join(module_path, "reports/quality_report_data.xml"),
        os.path.join(module_path, "reports/quality_report.xml"),
    ]
